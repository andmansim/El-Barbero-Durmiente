...
Mi dirección de GitHub es la siguiente: [GitHub](https://github.com/andmansim/El-Barbero-Durmiente.git)
https://github.com/andmansim/El-Barbero-Durmiente.git

El ejercicio está realizada en ejercicio.py, basado en el código de ejemplo del enunciado.
# Ejercicio.py
```
import random 
import time
